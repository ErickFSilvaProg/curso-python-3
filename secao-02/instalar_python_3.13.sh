...
# Baixar o Python 3.13.3
echo "Baixando Python 3.13.3..."
cd /tmp
wget https://www.python.org/ftp/python/3.13.3/Python-3.13.3.tgz

# Extrair e compilar
echo "Extraindo e compilando Python 3.13.3..."
...
echo "Instalando Python 3.13.3 com altinstall..."
...
echo ""
echo "Python 3.13.3 instalado com sucesso!"
echo "Se quiser usar python3 apontando para essa versão, rode:"
echo "  sudo update-alternatives --install /usr/bin/python3 python3 /usr/local/bin/python3.13 1"
